...
%   hSI.hIntegrationRoiManager.postProcessFcn = @integrationPostProcessingFcn_test1b;
%
function integrationValues = integrationPostProcessingFcn_test1b(rois,integrationDone,arrayIndices,integrationValueHistory,integrationTimestampHistory,integrationFrameNumberHistory)
% TEST1B:
