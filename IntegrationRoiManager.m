classdef IntegrationRoiManager < scanimage.interfaces.Component
    ...
    properties (SetObservable)
        ...
        % THK (2025 Feb 8): To log non-ROI values in the BCI experiment
        decoder_values = [];
    end
        ...
        function reinit(obj)
            try
                ...
                for idx = 1:numel(hChannels)
                    ...
                    obj.hIntegrationRoiOutputChannels(end+1) = hChannel;
        ...
        function update(obj,stripeData)
            ...
            if stripeData.endOfVolume
                ...
                if obj.hSI.hChannels.loggingEnable
                    ...
                    % THK (2025 Feb 8): To log non-ROI values in the BCI experiment
                    decoderValStrings = sprintf(',%d', obj.decoder_values);

                    fprintf(obj.csv_fid, '%f,%i%s%s\r\n', stripeData.frameTimestamp, stripeData.frameNumberAcqMode, intValStrings, decoderValStrings);
                end
